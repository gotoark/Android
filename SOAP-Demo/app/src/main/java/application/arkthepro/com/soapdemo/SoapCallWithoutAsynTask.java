...
public class SoapCallWithoutAsynTask extends AppCompatActivity {
    ...
    public void getSoap(String param1,String param2,String param3,String soapType){
        ...
        //HttpsTransportSE androidhttpsTransportSE=new HttpsTransportSE(URL);
        try{
            //Call webservice
        ...
        {
            tv_result.setText("SocketTimeoutException Occured Try With Asyntask \n Note: Make SoapCallwithAsynTask as Main Activity in Manifest");
            e.printStackTrace();
        }
