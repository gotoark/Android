package arkthepro.com.slideshowmaker.Adapters;
...
import arkthepro.com.slideshowmaker.ImagePreviewActivity;
import arkthepro.com.slideshowmaker.R;

/**
 * Created by rajesharumugam on 13-10-2017.
 */
...
public class MediaResultsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            switch (itemViewType) {
                case TYPE_IMAGE:
                    convertView = LayoutInflater.from(context).inflate(R.layout.adpter_images, null);
                    break;
                /*case TYPE_FILE:
